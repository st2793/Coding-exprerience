...
### 오류(오개념)
* 완전 탐색의 개념을 이해하고, 어떤 유형을 이용해 풀것인지 떠올릴 수 있어야한다.
* 완전탐색의 문제는 시간복잡도를 먼저 고려하고문제를 풀어야한다. 그렇지 않으면 시간은 공대로 다들이고, 코드제출시 효율성으로인해 틀린것을 모른채 체출되기 때문이다. 
* 특정노드로 이동했을때 이동가능한 노드(방문하지 않은 노드)를 명확히 해야한다. 
...
* [양과 늑대 쉬운설명](https://programmers.co.kr/questions/25736  양과늑대 문제 쉬운설명) 
